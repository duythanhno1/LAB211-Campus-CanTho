...
public class Manager {
     ...
     * @param count number user input student
     * @param ls list
     */
     ...
     * @param ls list
     * @return value search in list of student
     */
     ...
     * @param count value user input student
     * @param ls list 
     */
     ...
     * @param listStudentFindByName list find by name
     * @return Find name and show 
     */
